  ...
  ***************************************************************************** */
  ...
  class Virtual {
    constructor(store, fn, ...fields) {
      this.store = store;
      this.fn = fn;
      this.fields = flattenDeep_1(fields);
    }
  ...
  const isFunction$3 = val.is('function');
  ...
  class ValueStore {
    ...
    select(...fields) {
      const properties = uniq_1(flattenDeep_1(fields));
    ...
    _initVirtuals(obj) {
      Object.keys(obj).forEach((method) => {
        this.virtual(method, ...flattenDeep_1(obj[method]));
      });
    }
    ...
    values(...fields) {
      return flattenDeep_1(fields).reduce((out, field) => {
